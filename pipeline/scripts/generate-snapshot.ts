 ...
 *   npx -y tsx pipeline/scripts/<stage-name>.ts
 *
...
const STAGE_SCRIPTS = [
  { label: "1a. Scrape Forestry (raw HTML)", script: "pipeline/scripts/scrape-forestry.ts" },
  { label: "1b. Scrape Closures (raw HTML)", script: "pipeline/scripts/scrape-closures.ts" },
  { label: "1c. Scrape Total Fire Ban (raw JSON)", script: "pipeline/scripts/scrape-total-fire-ban.ts" },
  { label: "2a. Parse Forestry", script: "pipeline/scripts/parse-forestry.ts" },
  { label: "2b. Parse Closures", script: "pipeline/scripts/parse-closures.ts" },
  { label: "2c. Parse Total Fire Ban", script: "pipeline/scripts/parse-total-fire-ban.ts" },
  { label: "3.  Geocode Forests", script: "pipeline/scripts/geocode-forests.ts" },
  { label: "4.  Enrich Closures", script: "pipeline/scripts/enrich-closures.ts" },
  { label: "5.  Assemble Snapshot", script: "pipeline/scripts/assemble-snapshot.ts" }
];
